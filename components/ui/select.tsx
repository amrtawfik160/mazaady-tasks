...
const menuStyles = 'mt-2 p-2 border bg-white border-border bg-background text-sm rounded-lg';
const optionsStyle =
  'bg-background px-2 py-1 border-0 text-base hover:bg-secondary hover:cursor-pointer';
